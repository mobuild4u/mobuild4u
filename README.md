...
- 9+ years in mobile and web development
- Specialized in React Native, TypeScript, and scalable cross-platform architecture
- Experienced with native integrations, app performance, CI/CD, and store releases
- Comfortable owning delivery from product discovery to App Store and Google Play launch
...
- Payments, push notifications, deep linking, and real-time app experiences
- CI/CD pipelines and production delivery
